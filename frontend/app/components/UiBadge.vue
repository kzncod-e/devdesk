...
const toneClasses: Record<string, string> = {
  gray: 'bg-slate-100 text-slate-600 ring-slate-200/70 dark:bg-slate-400/10 dark:text-slate-300 dark:ring-slate-300/15',
  ...
  indigo: 'bg-indigo-100 text-indigo-700 ring-indigo-200/70 dark:bg-indigo-400/10 dark:text-indigo-300 dark:ring-indigo-400/20',
}
